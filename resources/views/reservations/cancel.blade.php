...
@section('title', __('mail.cancel_reservation'))

@section('content')
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-8 text-center">{{ __('mail.cancel_reservation') }}</h1>
    <p class="text-center mb-4">{{ __('mail.cancel_info') }}</p>
